...
class Student1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student1" do
    assert_difference('Student1.count') do
      post student1s_url, params: { student1: { address: @student1.address, age: @student1.age, course: @student1.course, mobileno: @student1.mobileno, name: @student1.name, regno: @student1.regno } }
    end
  ...
  test "should update student1" do
    patch student1_url(@student1), params: { student1: { address: @student1.address, age: @student1.age, course: @student1.course, mobileno: @student1.mobileno, name: @student1.name, regno: @student1.regno } }
